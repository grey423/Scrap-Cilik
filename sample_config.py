...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "scrapcilikbot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "scrapcilikbot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/scrapcilikbot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/scrapcilikbot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Managed With By @greyyvbss")
